...
namespace RSML_web_app.Controllers
{
    public class UnresolvedsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,DeviceId,SuspiciousActivities,_Date,TimeOccured, StoreName, StoreLocation")] Unresolved unresolved)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,DeviceId,SuspiciousActivities,_Date,TimeOccured, StoreName, StoreLocation")] Unresolved unresolved)
        {
            if (ModelState.IsValid)
            {
