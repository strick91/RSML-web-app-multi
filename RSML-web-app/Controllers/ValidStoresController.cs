...
namespace RSML_web_app.Controllers
{
    public class ValidStoresController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,StoreNumber,StoreName")] ValidStores validStores)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,StoreNumber,StoreName")] ValidStores validStores)
        {
            if (ModelState.IsValid)
            {
